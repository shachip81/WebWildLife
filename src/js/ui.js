...
function toggleLoading(isLoading) {
  ...
  var search_icon = document.getElementById("btn_search").getElementsByTagName("i")[0];
  var search_btn_text = document.getElementById("btn_search").getElementsByTagName("span")[0];
  
  if(isLoading){
	search_icon.classList.remove("fa-search");
	search_icon.classList.add("fa-hourglass-half");
	search_btn_text.innerText = "Loading..."
	search_btn.disabled = true;
  }
  else {
	search_icon.classList.add("fa-search");
	search_icon.classList.remove("fa-hourglass-half");
	search_btn_text.innerText = "Search";
